...
syno=['best___good','good___best','get___getting','getting___get','indian___india','india___indian','use___using','using___use',
      ...
      'engineering___engineers','get___got','got___get','phone___mobile','mobile___phone','pok├ú┬®mon___pokemon',
      'pokemon___pok├ú┬®mon','take___taking','taking___take','development___developer','developer___development',
